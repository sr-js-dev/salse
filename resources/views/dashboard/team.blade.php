      ...
      <table id="datatable" class="table table-striped table-bordered" style="color:black;font-family:'sans-serif'">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="col">{{$member->role}}</td>
            <td class="col">{{$member->email}}</td>
            <td class="col">{{$member->phone}}</td>
            <td class="col">{{$member->territory}}</td>
            <td class="col">{{$member->region}}</td>
            <td class="col">{{$member->area}}</td>
            <td class="col">{{$member->address}}</td>
            <td class="col">
