        ...
        <div class="col-md-auto">
            <table id="datatable" class="table table-striped table-bordered" style="color:black;font-family:'sans-serif'">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="col">{{$services->classification}}</td>
                        <td class="col">{{$services->service}}</td>
                        <td class="col">{{$services->type}}</td>
                        <td class="col">{{$services->product_1}}</td>
                        <td class="col">{{$services->model_1}}</td>
                        <td class="col">{{$services->product_2}}</td>
                        <td class="col">{{$services->model_2}}</td>
                        <td class="col">
                            <i class="fa fa-edit fa-xs" style="color: #337ab7;cursor: pointer;" onclick="editServiceModal({{$services->id}})"></i>
                            <i class="fa fa-trash fa-xs" style="color:#d9534f;cursor: pointer;"  onclick="deleteServiceModal({{$services->id}})"></i>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-sales">
            ...
            <div class="modal-body" style="display: inline;">
                <form method="post" id="add_service" action="{{url('add-service')}}" class="needs-validation">
                    @csrf
...
<div class="modal fade" id="editServiceModal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-sales">
            ...
            <div class="modal-body" style="display: inline;">
                <form method="post" id="edit_service" action="{{url('update-service')}}" class="needs-validation">
                    @csrf
                    <div class="form-group">
                        <label class="control-label col-md-3">Classification</label>
                        <div class="col-md-9">
...
<div class="modal fade" id="deleteServiceModal" role="dialog" >
  <div class="modal-dialog">
    <div class="modal-sales">
      ...
      <div class="modal-body" style="display: inline;">
        <form method="post" id="deleteService" action="{{url('delete-service')}}" class="needs-validation">
          @csrf
