        ...
        <div class="col-md-auto">
            <table id="datatable" class="table table-striped table-bordered" style="color:black;font-family:'sans-serif'">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="col">{{$accounts->customer}}</td>
                        <td class="col">{{$accounts->division}}</td>
                        <td class="col">{{$accounts->address}}</td>
                        <td class="col">{{$accounts->city}}</td>
                        <td class="col">{{$accounts->state}}</td>
                        <td class="col">{{$accounts->pocname}}</td>
                        <td class="col">{{$accounts->phone}}</td>
                        <td class="col">{{$accounts->email}}</td>
                        <td class="col">
                        ...
                        <!-- <td class="col"><a href="/dashboard/accounts/remove/{{$accounts->id}}" class="btn btn-danger" data-method="DELETE" data-confirm="Are you sure?"><i class="fa fa-trash"></a></td> -->
                    </tr>
                    @endforeach
                </tbody>
            </table>
