            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{URL::asset('/')}}">
                        <img width="220px" height="120px" src="{{URL::asset('img/logo.png')}}" alt="Sales C2" class="img-responsive" />
                    </a>
                </div>
                <div id="navbar" class="collapse navbar-collapse navbar-right">
                    ...
                    <a href="javascript:void(0);" data-toggle="modal" data-target="#loginModal"><img src="{{URL::asset('img/humburger-menu.png')}}" alt="" class="humburger-menu" /></a>
                </div>
                <!--<div id="navbar" class="collapse navbar-collapse navbar-right">
        ...
        <div class="modal-dialog modal-md loginmodalbox" style="font-family:none">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="" id="myModalLabel"><img src="{{URL::asset('img/footer-logo.png')}}" alt="" width="100" /></h4>
                </div>
                    ...
                    <div class="row p-t-b p-b-0">
                        <div class="col-md-12 col-sm-12 txt-right">
                            <div class="menu-links">
                                <a href="{{URL::asset('about-us')}}" style="color: white;">About Us</a><br/>
                                <a href="{{URL::asset('products')}}" style="color: white;">Products</a><br/>
                                <a href="{{URL::asset('contact-us')}}" style="color: white;">Contact Us</a>
                            </div>
                        </div>
                    </div>
            ...
            <div style="color:white;">
                <div class="login-form-2 loginBox">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            <input id="email" type="email" class="form-login form-control @error('email') is-invalid @enderror" name="email" required autocomplete="email" autofocus placeholder="Email *" value="" />
                        </div>

                        <div class="form-group">
                            <input id="password" type="password" class="form-login form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Password *" value="" />
                            @error('password')
                ...
                <div class="login-form-2 registerBox" style="display:none;">
                    ...
                    <form method="POST" class="register-form" id="login-form" action="{{ route('register') }}">
                        {{csrf_field()}}
                        <div class="form-group">
                            <input id="name" type="text" class="form-login form-control {{$errors->has('name') ? 'is-invalid':''}}" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Full Name *" />
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group">
                            <input id="phone" type="text" class="form-login form-control {{$errors->has('phone') ? 'is-invalid':''}}" placeholder="Phone Number *" value="" name="phone" required autocomplete="phone"/>
                            @if ($errors->has('phone'))
                                <span class="help-block">
                        ...
                        <div class="form-group">
                            <input id="register_email" type="email" class="form-login form-control {{$errors->has('email') ? 'is-invalid':''}}" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Email *"/>
                            @if ($errors->has('email'))
                                <span class="help-block">
                        ...
                        <div class="form-group">
                            <input id="register_password" type="password" class="form-login form-control {{$errors->has('password') ? 'is-invalid':''}}" name="password" required autocomplete="new-password" placeholder="Password *" value="" />
        ...
        <div class="modal-dialog modal-md loginmodalbox" style="font-family:none">
            ...
            <div class="container-contact100">
                ...
                <div class="wrap-contact100">
                    ...
                    @endif
                    <form class="contact100-form validate-form" method="post" action="{{ route('request.store')}}">
                        @csrf
        ...
        <div class="container">
            <div class="navbar-header">
               <button type="button" class="navbar-toggle collapsed dashboard-mobile" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
                ...
                <a class="navbar-brand" href="{{URL::asset('/')}}">
               <!-- <img src="{{URL::asset('img/logo.png')}}" alt="Sales C2" class="img-responsive" /> -->
                    <img width="209px" height="77px" src="{{URL::asset('img/logo.png')}}" alt="Sales C2" class="img-responsive" />
                </a>
            </div>
            <div id="navbar" class="collapse navbar-collapse navbar-right" style="display:flex!important;">
            <button onclick="location.href='{{ URL::asset('dashboard/') }}';" type="button" name="dashboard" value="Dashboard" class="login-btn">Dashboard</button>
                <button onclick="event.preventDefault(); document.getElementById('logout-form').submit();" type="button" name="login" value="Logout" style="display:flex;"class="login-btn"><p style="color:#bb0000;margin:0px 0 0px;!important;">{{ Auth::user()->name }}</p>/Logout</button>
        ...
        <div class="modal-dialog modal-md loginmodalbox" style="font-family:none">
            <div class="modal-content">
                <div class="modal-header" style="color:white;">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="myModalLabel"><img src="{{URL::asset('img/footer-logo.png')}}" alt="" width="100" /></h4>
                </div>
                <div class="modal-body" style="background:#2e488a;">
                    <div class="row">
                        <div class="col-md-8 col-sm-6">
                        ...
                        <div class="col-md-4 col-sm-6 txt-right">
                            ...
                            <div><a onClick="event.preventDefault(); document.getElementById('logout-form').submit();" style="width: auto!important; height: auto!important;" class="loginmodalbox a request-modal-btn"><p style="color:#bb0000;">{{ Auth::user()->name }}</p>logout</button></a></div>
                            <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: one;">
                                {{ csrf_field() }}
                            </form>
                        </div>
                    ...
                    <div class="row p-t-b p-b-0">
                        <div class="col-md-12 col-sm-12 txt-right">
                            <div class="menu-links" style="color:white;">
                                <a href="{{URL::asset('about-us')}}">About Us</a><br/>
                                <a href="{{URL::asset('products')}}">Products</a><br/>
