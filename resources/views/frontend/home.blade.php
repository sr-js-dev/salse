...
@section('content')
    <section class="home-page" style="margin-top:100px;" >
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <a href="#section01" class="arrow-down"><img src="{{URL::asset('img/down-arrow.png')}}" alt="" /></a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row p-t">
                <div class="col-md-6 col-sm-6">
                    <img src="{{URL::asset('img/img-sm-one.jpg')}}" alt="" />
                </div>
                <div class="col-md-6 col-sm-6">
            ...
            <div class="row p-t-b">
                ...
                <div class="col-md-5 col-sm-5">
                    <img src="{{URL::asset('img/img-sm-two.png')}}" alt="" style="border: 0" />
                </div>
            </div>
            <div class="row p-t-b">
                <div class="col-md-6 col-sm-6">
                    <img src="{{URL::asset('img/img-sm-three.jpg')}}" alt="" />
                </div>
                <div class="col-md-6 col-sm-6">
