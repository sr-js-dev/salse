    ...
    <div class="container">
        <div class="row customer-dashboard">
            <div class="col-sm-5" style="padding:0 15px 0 15px!important;">
                <div class="dashboard-table">&nbsp;&nbsp;&nbsp;TASK<a class="dashboard-table" href="<?php echo e(URL::asset('dashboard/tasks')); ?>"><i class="dashboard-zoom-icon glyphicon glyphicon-fullscreen blinking"></i></a></div>
                <div class="dashboard dashboard-task table-responsive">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $schedule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td style="font-size:12px;"><?php echo e($value->customer); ?></th>
                                <td style="font-size:12px;"><?php echo e($value->service); ?></td>
                                <td style="font-size:12px;"><?php echo e($value->date); ?></td>
                                <td style="font-size:12px;"><?php echo e($value->time); ?></td>
                                <?php if($value->status =='Complete'): ?>
                                <td style="font-size:15px;" class="col complete-blinking"><b><?php echo e($value->status); ?></td>
                                <?php elseif($value->status =='Incomplete'): ?>
                                <td style="font-size:15px;" class="col incomplete-blinking"><b><?php echo e($value->status); ?></td>
                                <?php elseif($value->status =='Canceled'): ?>
                                <td style="font-size:15px;" class="col canceled-blinking"><b><?php echo e($value->status); ?></td>
                                <?php elseif($value->status =='Inprogress'): ?>
                                <td style="font-size:15px;" class="col inprogress-blinking"><b><?php echo e($value->status); ?></td>
                                <?php elseif($value->status =='Unassigned'): ?>
                                <td style="font-size:15px;" class="col text-black"><b><?php echo e($value->status); ?></td>
                ...
                <div class="dashboard dashboard-schedule">
                    <div class="dashboard-table">&nbsp;&nbsp;&nbsp;SCHEDULE<a class="dashboard-table" href="<?php echo e(URL::asset('dashboard/calendar')); ?>"><i class="dashboard-zoom-icon glyphicon glyphicon-fullscreen blinking"></i></a></div>
                ...
                <div class="dashboard report">
                    <div class="dashboard-table">&nbsp;&nbsp;&nbsp;REPORT<a class="dashboard-table" href="<?php echo e(URL::asset('dashboard/reporting')); ?>"><i class="dashboard-zoom-icon glyphicon glyphicon-fullscreen blinking"></i></a></div>
                    <table class="table">
                        <tbody>
                            <tr>
                                <td class="text-center" style="font-size:30px;font-weight:600;">
                                    <h4 class="text-light" style="font-size:16px;">SALES REP</h4>
                                    <span class="empty-space"><?php echo e($assigned_rep_sales_count); ?></span>
                                </td>
                                <td class="text-center" style="font-size:30px;font-weight:600;">
                                    <h4 class="text-black" style="font-size:16px";>TOTAL TASK</h4>
                                    <span class="empty-space text-black"><?php echo e($total_tasks); ?></span>
                                </td>
                                <td class="text-center" style="font-size:30px;font-weight:600;">
                                    <h4 class="complete-blinking" style="font-size:16px;">COMPLETED TASK</h4>
                                    <span class="empty-space complete-blinking"><?php echo e($complete_tasks); ?></span>
                                </td>
                            ...
                            <tr>
                                <td class="text-center" style="font-size:30px;font-weight:600;">
                                    ...
                                    <span class="empty-space inprogress-blinking"><?php echo e($inprogress_tasks); ?></span>
                                </td>
                                <td class="text-center" style="font-size:30px;font-weight:600;">
                                    <h4 class="canceled-blinking" style="font-size:16px;">CANCELED</h4>
                                    <span class="empty-space canceled-blinking"><?php echo e($canceled_tasks); ?></span>
                                </td>
                                <td class="text-center" style="font-size:30px;font-weight:600;">
                                    <h4 class="incomplete-binking" style="font-size:16px;">INCOMPLETED TASK</h4>
                                    <span class="empty-space incomplete-binking"><?php echo e($incomplete_tasks); ?></span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="col-sm-7 dashboard-map"><?php echo $map['html']; ?></div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.calendarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Code\Laravel\salesc2(0511-complete)\resources\views/dashboard/index.blade.php ENDPATH**/ ?>